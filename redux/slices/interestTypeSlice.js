...
export const createInterestType = createAsyncThunk(
  "interestType/create",
  async (payload) => {
    try {
      const response = await axios.post(
        API_URL + "/interest-type/create",
        {
          headers: {
...
export const getInterestType = createAsyncThunk(
  "interestType/all",
  async () => {
...
export const calculateInterest = createAsyncThunk(
  ...
  async (payload) => {
    const response = await axios.post(
      `${API_URL}/interest-type/calculate`,
      payload
    );
    return response.data;
  }
...
const interestTypeSlice = createSlice({
  ...
  reducers: {
    clearUserState: (state) => {
      state.data = null;
      (state.interestValue = null), (state.loading = "idle");
      state.error = null;
    },
  },
