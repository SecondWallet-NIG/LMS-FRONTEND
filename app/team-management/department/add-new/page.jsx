        ...
        dispatch(createDepartment({ payload }))
            ...
            .then(res => {
                setState(draft => {
                    ...
                    draft.successMessage = res?.messsage || 'Department created successfully.';
                    draft.loading = false;
                    draft.name = ""
                    draft.departmentHead = ""
                    draft.description = ""
                });
            })
            .catch(err => {
                setState(draft => {
                    ...
                    draft.failedMessage = err?.message || 'Department creation failed.';
                    draft.loading = false
                });
            });
    };
        ...
        <DashboardLayout isBackNav={true} paths={["Team Management", "New Department"]}>
            <div className="mx-auto w-full px-5 lg:px-1 lg:w-3/5 my-20">
                ...
                <div className="p-3 border-t flex items-center justify-end gap-2 w-full">
                    <Button disabled={state.loading || !state.departmentHead || !state.name || !state.description}
            ...
            <SuccessModal
                ...
                title={"Department Creation Successful"}
                btnLeft={"Department"}
