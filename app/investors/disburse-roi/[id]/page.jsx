...
export default function DisburseROI() {
    const mtHeadClass = 'flex justify-between gap-44 mb-1'
    ...
    const bankName = bankArr.find(option =>
        option.value === bankDetails?.bankAccount?.bankName
    )?.label
    ...
    return (
        ...
        >
            <div className="px-6 lg:w-1/2 mx-auto mt-20 pb-10">
                ...
                <div className="flex gap-44 my-5">
