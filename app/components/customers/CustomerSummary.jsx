...
import { getLoanApplicationSummary, getCustomerLoanApplicationSummary } from "@/redux/slices/loanApplicationSlice";
import { useParams } from "next/navigation";

const CustomerSummary = () => {
  const dispatch = useDispatch();
  const { loading, error, data } = useSelector((state) => state.loanApplication);
  const { id } = useParams();
  // const data = [
