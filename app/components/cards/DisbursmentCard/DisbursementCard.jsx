...
const DisbursementCard = ({ _data }) => {
  ...
  return (
    <div className=" text-sm mt-8 mr-4 ml-4">
      <div className="italic text-swBlue">
        Disbursed loans includes loans with statuses "DISBURSED" and "FULLY
        PAID"
      </div>
      <main className="grid lg:grid-cols-3 sm:grid-cols-3 grid-cols-1 gap-2 text-sm mt-4">
        {data &&
