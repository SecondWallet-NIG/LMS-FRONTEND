      ...
      <div className="p-2 border-2 rounded-lg h-full">
        <div className="flex justify-between">
          ...
          {(!data?.employeeBenefit || isDashboard) && (
            <Button
              className="bg-white border border-swBlue text-swBlue hover:text-white hover:bg-swDarkBlue text-xs md:p-[0.37rem] rounded-md ml-2 whitespace-nowrap"
              onClick={() => setOpenLeaveRequestModal(true)}
            >
