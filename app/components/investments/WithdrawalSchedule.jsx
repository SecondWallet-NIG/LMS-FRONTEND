            ...
            status: (
                <button
                    className={`${item.status === "New"
                        ? "bg-[#E7F1FE] text-swBlue text-xs font-normal px-2 py-1 rounded-md"
                        : item.status === "Paid"
                        ...
                        py-1 px-2 border rounded-md flex w-fit text-xs items-center gap-1`}
                >
                    <div
                        className={`h-1 w-1 rounded-full ${item?.status === "New"
                            ? "bg-blue-500"
                            : item?.status === "Paid"
                                ? "bg-green-500"
                                : item?.status === "Cancelled"
